...
export default function App() {
  return (
    ...
    >
      ...
      {/* Get Started Button */}
      <Link className="text-2xl font-bold bg-gray-500 px-5 py-4 my-6 text-white rounded-lg" href="/home">
        Log in
      </Link>
      <Link className="text-2xl font-bold bg-gray-500 px-5 py-4 my-6 text-white rounded-lg" href="/login">
        Sign up
      </Link>
